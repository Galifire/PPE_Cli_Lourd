...
public class WindowController {
    ...
    public WindowController(Window window, Session session, User user) {
        ...
        window.getTablePanel().setSize((int) (0.8*window.getWidth()), (int) (0.8*window.getHeight()));
        window.getDataScrolLPane().setSize((int) (0.8*window.getWidth()), (int) (0.8*window.getHeight()));
